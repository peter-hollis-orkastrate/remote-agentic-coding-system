...
This guide walks you through setting up Jira and Bitbucket integrations for the Remote Agentic Coding System, including the automated PR review feature.

## Table of Contents

1. [Prerequisites](#prerequisites)
2. [Jira Setup](#jira-setup)
3. [Bitbucket Setup](#bitbucket-setup)
4. [Automated PR Review Setup](#automated-pr-review-setup)
...
- A running instance of the Remote Agentic Coding System
- Admin access to your Jira Cloud instance
- Admin access to your Bitbucket workspace
- A publicly accessible URL for webhooks (or use ngrok for testing)
